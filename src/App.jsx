...
function App() {
  ...
  if (!user) {
    return (
      <Box minH="100vh" w="100vw" bg="beige.100" display="flex" alignItems="center" justifyContent="center" position="relative" overflow="hidden">
        {/* SVG Illustration Background */}
        <Box position="absolute" top={0} left={0} w="100vw" h="100vh" zIndex={0} pointerEvents="none">
          <svg width="100vw" height="100vh" viewBox="0 0 1440 900" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100vw', height: '100vh' }}>
            ...
            <rect x="900" y="600" width="300" height="120" rx="40" fill="#e6d3b0" opacity="0.10" />
            {/* Example monitor illustration */}
            <rect x="320" y="350" width="160" height="100" rx="16" fill="#ede1d6" stroke="#b98e6a" strokeWidth="4" />
            <rect x="370" y="390" width="60" height="20" rx="6" fill="#bfa06a" opacity="0.25" />
            {/* Example avatar illustration */}
            <ellipse cx="400" cy="340" rx="40" ry="50" fill="#b98e6a" opacity="0.35" />
            <ellipse cx="400" cy="340" rx="30" ry="35" fill="#ede1d6" />
            {/* Decorative lines */}
            <line x1="320" y1="470" x2="480" y2="470" stroke="#bfa06a" strokeWidth="2" opacity="0.2" />
            <line x1="320" y1="480" x2="480" y2="480" stroke="#bfa06a" strokeWidth="2" opacity="0.1" />
          </svg>
        </Box>
        <Box zIndex={1} w={["90vw", "400px"]}>
          {showLogin ? (
            <>
              <Box bg="coffee.500" borderRadius="xl" boxShadow="2xl" p={8}>
                <Box mb={4} textAlign="center">
                  <Text fontSize="2xl" fontWeight="bold" color="beige.50" letterSpacing="wide">Login</Text>
                </Box>
                <Login />
            ...
            <>
              <Box bg="coffee.500" borderRadius="xl" boxShadow="2xl" p={8}>
                <Box mb={4} textAlign="center">
                  <Text fontSize="2xl" fontWeight="bold" color="beige.50" letterSpacing="wide">Register</Text>
                </Box>
